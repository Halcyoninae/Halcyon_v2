...
public abstract class TAudioFileWriter
     ...
     */
    private final Collection<AudioFileFormat.Type> m_audioFileTypes;
    ...
    private final Collection<AudioFormat> m_audioFormats;
    ...
    public int write(AudioInputStream audioInputStream,
        ...
        if (isAudioFormatSupportedImpl(inputFormat, fileType)) {
            ...
            if (outputFormat != null) {
                ...
                bNeedsConversion = outputFormat.getSampleSizeInBits() != 8
