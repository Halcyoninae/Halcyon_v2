...
public class Lame {
    ...
    private static final int DEFAULT_QUALITY = QUALITY_MIDDLE;
    private static final int DEFAULT_BITRATE = BITRATE_AUTO;
    private static final int DEFAULT_CHANNEL_MODE = CHANNEL_MODE_AUTO;
    // in VBR mode, bitrate is ignored.
    private static final boolean DEFAULT_VBR = false;
