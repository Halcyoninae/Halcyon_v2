...
public class Lpc {
    ...
    private void Reflection_coefficients(short[] r /* 0...7 OUT */)
        ...
        if (L_ACF[0] == 0) {
            throw new IllegalArgumentException(
                    "Reflection_coefficients: L_ACF[0] = " + L_ACF[0]
                            + " should not = 0.");
        }
        ...
        if (!(temp >= 0 && temp < 32)) {
            throw new IllegalArgumentException(
                    "Reflection_coefficients: temp = " + temp
                            + " should be >= 0 and < 32.");
        }
    ...
    private void Transformation_to_Log_Area_Ratios(short[] r /* 0..7 IN/OUT */)
        ...
        for (int i = 0; i < 8; i++) {
            ...
            if (!(temp >= 0)) {
                throw new IllegalArgumentException(
                        "Transformation_to_Log_Area_Ratios: temp = " + temp
                                + " should be >= 0 ");
            }
    ...
    private void STEP2(int A, int B, int MAC, int MIC, short[] LAR, int index) {
        ...
        LAR[index] = (short) (temp > MAC ? MAC - MIC : (temp < MIC ? 0 : temp
                - MIC));
    }
}
