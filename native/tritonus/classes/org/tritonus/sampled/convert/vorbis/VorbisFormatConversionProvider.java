...
// 	};
    ...
    private static final boolean LIB_AVAILABLE = Ogg.isLibraryAvailable();
    ...
    public static class EncodedVorbisAudioInputStream
        ...
        private final byte[] m_abReadbuffer;

        private final StreamState m_streamState;
        private final Page m_page;
        private final Packet m_packet;

        private final Info m_info;
        private final Comment m_comment;
        private final DspState m_dspState;
        ...
        public EncodedVorbisAudioInputStream(
            ...
            if (property instanceof Integer) {
                ...
                bUseVBR = true;
                if (TDebug.TraceAudioConverter)
                    TDebug.out("using quality (automatically switching VBR on): " + fQuality);
            }
            ...
            if (property instanceof Integer) {
                ...
                bUseVBR = false;
                if (TDebug.TraceAudioConverter)
                    TDebug.out("using nominal bitrate (automatically switching VBR off): " + nNominalBitrate);
            }
            ...
            if (bUseVBR) {
                ...
                if (TDebug.TraceAudioConverter)
                    TDebug.out("using fixed bitrate(max/nom/min): " + nMaxBitrate + "/" + nNominalBitrate + "/" + nMinBitrate);
