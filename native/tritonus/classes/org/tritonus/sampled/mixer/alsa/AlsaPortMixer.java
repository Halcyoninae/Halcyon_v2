...
public class AlsaPortMixer
     ...
     */
    private final List<AlsaMixerElement> m_mixerElements;

    /**
     * Port.Infos are keys, Port instances are values.
     */
    private final Map<Port.Info, Port> m_portMap;

    /**
     * Port.Infos are keys, AlsaMixerElement instances are values.
     */
    private final Map<Port.Info, AlsaMixerElement> m_mixerElementMap;
...
*/
    ...
    private class AlsaVolumeControl
        ...
        private final AlsaMixerElement m_element;
        private final int m_nChannel;

        /**
         * One of the constants DIRECTION_*.
         */
        private final int m_nDirection;
