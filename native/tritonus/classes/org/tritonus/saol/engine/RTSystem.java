...
public class RTSystem
    ...
    private final SystemOutput m_output;
    ...
    private final List m_activeInstruments;
    private final List m_scheduledInstruments;
    ...
    private AbstractInstrument createInstrumentInstance(String strInstrumentName) {
        ...
        try {
            Constructor constructor = instrumentClass.getConstructor(RTSystem.class);
