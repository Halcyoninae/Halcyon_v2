...
public abstract class FloatControl
    ...
    private final float m_fMinimum;
    private final float m_fMaximum;
    private final float m_fPrecision;
    private int m_nUpdatePeriod;
    private String m_strUnits;
    private final String m_strMinLabel;
    private final String m_strMidLabel;
    private final String m_strMaxLabel;
