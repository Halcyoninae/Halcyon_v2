...
*/
    ...
    private interface MixerProviderAction {
        boolean handleMixerProvider(MixerProvider mixerProvider);
    }


    private interface MixerAction {
        boolean handleMixer(Mixer mixer);
    }


    private interface FormatConversionProviderAction {
        boolean handleFormatConversionProvider(FormatConversionProvider formatConversionProvider);
        // throws IOException;
    }


    private interface AudioFileReaderAction {
        boolean handleAudioFileReader(AudioFileReader audioFileReader)
                throws IOException;
    }


    private interface AudioFileWriterAction {
        boolean handleAudioFileWriter(AudioFileWriter audioFileWriter)
                throws IOException;
    }
    ...
    private static class GetMixerInfoMixerProviderAction
        ...
        private final Collection<Mixer.Info> m_mixerInfos = new ArrayList<Mixer.Info>();
    ...
    private static class GetSourceLineInfoMixerAction
        ...
        private final Set<Line.Info> m_infos;
    ...
    private static class IsConversionSupportedFormatConversionProviderAction
            implements FormatConversionProviderAction {
        private final AudioFormat m_sourceFormat;
        /*
         *	May be AudioFormat or AudioFormat.Encoding.
         */
        private final Object m_targetDescription;
    ...
    private static class GetAudioInputStreamFormatConversionProviderAction
            implements FormatConversionProviderAction {
        private final AudioInputStream m_sourceAudioInputStream;
        private final Object m_targetDescription;
    ...
    private static class IsFileTypeSupportedAudioFileWriterAction
        ...
        private final AudioFileFormat.Type m_fileType;
