...
import mp4j.events.FVRightClick;
 ...
 * the interface {@link mp4j.components.BPTabs} in order to be a
 * qualified tab.
 * 
 * @author Jack Meng
 * @since 3.0
 * @see mp4j.components.BottomPane
 * @see mp4j.components.BPTabs
 */
public class FileView extends JScrollPane implements BPTabs {
   ...
   * globally in the {@link mp4j.Global} class.
   */
  public FileView() {
   ...
   * 
   * This scannable files are determined by {@link mp4j.Manager}
   * 
