...
public class LegalNoticeButton extends JButton implements BBlocButton {
    ...
    public LegalNoticeButton() {
        setIcon(DeImage.resizeImage(Global.ico.getFromAsImageIcon(LEGALNOTICEBBLOC_ICON_BUTTON_NORMAL), BBlocButton.DEFAULT_SIZE_BBLOC, BBlocButton.DEFAULT_SIZE_BBLOC));
