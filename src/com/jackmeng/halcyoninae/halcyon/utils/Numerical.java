...
public final class Numerical {
    ...
    public static double __safe_divide(double f1, double f2) {
        return __classifier_method(f1, f2, 0);
    }
     ...
     * @param bound Bound1 requires bound param
     * @return A double
     */
    private static double __classifier_method(double f1, double f2, double bound) {
        return f2 == bound ? bound : f1 / f2;
    }
}
