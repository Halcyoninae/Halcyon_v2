...
public class CdparanoiaMidLevel
    ...
    private class CddaAudioInputStream
         ...
         *
         */
        private final Cdparanoia m_cdparanoia;
         ...
         */
        private final int m_nStartFrame;
        ...
        public CddaAudioInputStream(String strDevice, int nTrack) {
            ...
            if (TDebug.TraceCdda) {
                TDebug.out("CddaAudioInputStream.<init>(): track length in cdda frames: " + m_nLengthCount);
            }
        ...
        public void execute() {
            ...
            if (!isEndOfTrackReached()) {
                ...
                while (getCircularBuffer().availableWrite() >= BUFFER_SIZE &&
                    ...
                    m_nLengthCount--;
                    if (TDebug.TraceCdda) {
                        TDebug.out("CddaAudioInputStream.execute(): length count now: " + m_nLengthCount);
                    }
                    if (TDebug.TraceCdda) {
