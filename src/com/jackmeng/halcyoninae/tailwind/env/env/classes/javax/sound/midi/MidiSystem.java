...
*/
    ...
    private interface MidiFileReaderAction {
        boolean handleMidiFileReader(MidiFileReader audioFileReader)
                throws IOException;
    }


    private interface MidiFileWriterAction {
        boolean handleMidiFileWriter(MidiFileWriter audioFileWriter)
                throws IOException;
    }
    ...
    private static class WriteMidiFileWriterAction
        ...
        private final Sequence m_sequence;
