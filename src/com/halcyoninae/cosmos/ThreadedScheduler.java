...
public class ThreadedScheduler {
    ...
    static {
        ...
        UIManager.put("ScrollBar.thumb", new ColorUIResource(ColorManager.MAIN_FG_THEME));
        UIManager.put("Scrollbar.pressedThumbColor", new ColorUIResource(ColorManager.MAIN_FG_THEME));
        UIManager.put("ScrollBar.hoverThumbColor", new ColorUIResource(ColorManager.MAIN_FG_THEME));
