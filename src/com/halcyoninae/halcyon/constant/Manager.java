...
public interface Manager {
    ...
    final String[] ALLOWED_FORMATS = new String[] { "wav", "mp3", "aiff", "aif", "aifc", "ogg", "oga" };
    ...
    final String PROGRAM_GREEN_LOGO = RSC_FOLDER_NAME + "/app/logo_green_ping.png";
    final String PROGRAM_BLUE_LOGO = RSC_FOLDER_NAME + "/app/logo_blue_ping.png";
    final String PROGRAM_RED_LOGO = RSC_FOLDER_NAME + "/app/logo_red_ping.png";
    final String PROGRAM_ORANGE_LOGO = RSC_FOLDER_NAME + "/app/logo_orange_ping.png";
    final String PROGRAM_PINK_LOGO = RSC_FOLDER_NAME + "/app/logo_pink_ping.png";
    ...
    final int SETTINGS_MIN_WIDTH = 500;
    final int SETTINGS_MIN_HEIGHT = 400;
