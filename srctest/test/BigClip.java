 ...
 * drain() (before
 * calling stop()) on the dataline after the play loop was complete. Improvement
 * to frame
 * and microsecond position determination.
 * <li>2009-08-17 - added convenience constructor that accepts a Clip. Changed
 * the private
 * convertFrameToM..seconds methods from 'micro' to 'milli' to reflect that they
 * were dealing
 * with units of 1000/th of a second.
 * <li>2009-08-14 - got rid of flush() after the sound loop, as it was cutting
 * off tracks just
 * before the end, and was found to be not needed for the fast-forward/rewind
 * functionality it
...
public class BigClip implements Clip, LineListener {
   ...
   * This
   * convenience constructor allows us to obtain a SourceDataLine for the BigClip
   * that uses
   ...
   * 
   * @return audioData byte[] The bytes of the audio data that is loaded in this
   *         Clip.
   */
  ...
  /**
   * Sets a parent component to act as owner of a "Loading track.." progress
   * dialog.
  ...
  /**
   * Determines the single largest sample size of all channels of the current
   * clip.
   * This can be handy for determining a fraction to scal visual representations.
   * 
   * @return Double between 0 & 1 representing the maximum signal level of any
   *         channel.
   */
